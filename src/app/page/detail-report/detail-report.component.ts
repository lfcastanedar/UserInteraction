...
import { WorkflowhistoryModalComponent } from './workflowhistory-modal/workflowhistory-modal.component';
import { ParticipantsModalComponent } from 'src/app/page/detail-report/participants-modal/participants-modal.component';
...
export class DetailReportComponent {
  ...
  constructor(
    ...
    this._workflowService.getWorkFlowHistories(this.report_id).subscribe(
      {
        next: (response: any) => {
          this.listOfWorkFlowHistories = response;
        }
      }
    ...
    this._complaintParticipantService.getById(this.report_id).subscribe(
      {
        next: (response) => {
          this.listOfComplaintParticipants = response
        }
      }
  ...
  ngOnInit(): void {
    ...
    this.dtOptions = {
      ...
      language: {
        ...
        emptyTable: 'Sin sujetos procesales'
      }
    };
